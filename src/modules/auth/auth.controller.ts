...
export class AuthController {
    ...
    @ApiOkResponse({ type: LoginResponse, description: 'Register success reponse' })
    @ApiBadRequestResponse({ type: BadRequestException, description: 'Bad Request Exception.' })
    async userRegisterInApp(@Body() registerInAppRequest: RegisterInAppRequest): Promise<LoginResponse> {
    ...
    @ApiOkResponse({ type: LoginResponse, description: 'Register success reponse' })
    @ApiBadRequestResponse({ type: BadRequestException, description: 'Bad Request Exception.' })
    async userLoginInApp(@Body() loginInAppRequest: LoginInAppRequest): Promise<LoginResponse> {
    ...
    @ApiOkResponse({ type: LoginResponse, description: 'Register success reponse' })
    @ApiBadRequestResponse({ type: BadRequestException, description: 'Bad Request Exception.' })
    async userLoginSNS(@Body() loginSNSRequest: LoginSNSRequest): Promise<LoginResponse> {
